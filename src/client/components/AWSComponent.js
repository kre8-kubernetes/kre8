  ...
  return (
    <div className="aws_cluster_form_container">
      ...
      <div className="aws_cluster_form_intro_text">
        Please input the details below to create your cluster.
         Once submitted, this phase takes AWS 10-15 minutes to complete.
      </div>
      ...
      <div className="aws_cluster_form_input_field_area">
          ...
          />
          {
            (!errors.iamRoleName) ? (
              <div className="aws_cluster_form_container_explainer_text">
                  *64 character max, including alphanumeric characters and &quot;+=,.@-_&quot;.
              </div>
            ) : (
        ...
        <div className="aws_cluster_form_container_inputs_item">
          ...
          />
          {
            (!errors.vpcStackName) ? (
              <div className="aws_cluster_form_container_explainer_text">
                *128 character max, including alphanumeric characters and dashes &quot;-&quot;.
              </div>
            ) : (
        ...
        <div className="aws_cluster_form_container_inputs_item">
          ...
          />
          {
            (!errors.clusterName) ? (
              <div className="aws_cluster_form_container_explainer_text">
                *100 character max, including alphanumeric characters,
      ...
      <div className="aws_cluster_form_container_button_item">
        <ActionButton
          id="aws_form_button"
          clickHandler={ handleConfigAndMakeNodes }
          buttonText="Submit"
        />
