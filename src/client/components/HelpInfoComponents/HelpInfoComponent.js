      ...
      ? (
        <div id="aws_more_info_component" className="more_info_component">
          ...
          <div id="aws_more_info_component_IAM_role">
            ...
            <div id="aws_more_info_component_IAM_role_text" className="more_info_paragraph">An Identity and Access Management (IAM) Role for EKS is the AWS role that has permission to manage your cluster.</div>
          </div>
          <div id="aws_more_info_component_VPC_stack">
            ...
            <div id="aws_more_info_component_VPC_stack_text" className="more_info_paragraph">An AWS VPC Stack represents a collection of resources necessary to manage and run a Kubernetes cluster.</div>
          </div>
          <div id="aws_more_info_component_cluster">
            ...
            <div id="aws_more_info_component_cluster_text" className="more_info_paragraph">An EKS Cluster consists of two primary components: The EKS Control Plane and Amazon EKS Worker Nodes which run the Kubernetes etcd and API Server.</div>
          </div>
