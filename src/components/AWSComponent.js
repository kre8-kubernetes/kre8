  ...
  return (
    <div className="aws_cluster_form_container">
      ...
      <div className='aws_cluster_form_container_input'>
        ...
        <div className='aws_cluster_form_container_explainer_text'>Role name can contain alphanumeric and '+=,.@-_' characters. Maximum 64 characters.</div>
      </div>
      ...
      <div className='aws_cluster_form_container_input'>
        ...
        <div className='aws_cluster_form_container_explainer_text'>Stack name can contain only alphanumeric characters and dashes '-'. Maximum 128 characters.</div>
      </div>
      ...
      <div className='aws_cluster_form_container_input'>
        ...
        <div className='aws_cluster_form_container_explainer_text'>Cluster name can contain only alphanumeric characters, dashes '-' and underscores '_'. Maximum 100 characters.</div>
      </div>
